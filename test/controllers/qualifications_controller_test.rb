...
class QualificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create qualification" do
    assert_difference('Qualification.count') do
      post qualifications_url, params: { qualification: { description: @qualification.description, provider_id: @qualification.provider_id, score: @qualification.score } }
    end
  ...
  test "should update qualification" do
    patch qualification_url(@qualification), params: { qualification: { description: @qualification.description, provider_id: @qualification.provider_id, score: @qualification.score } }
